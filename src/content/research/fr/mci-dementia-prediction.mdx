...
Ce stage pré-ingénieur de recherche s'inscrit dans le premier semestre de mon année ING-5 à l'ENSPY, sous la supervision du **Pr Tsopze Norbert** (Université de Yaoundé I), en collaboration avec le **Pr Bernard Fongang** (University of Texas, États-Unis). Le stage ingénieur du second semestre, en vue de l'obtention du diplôme, suivra séparément.
