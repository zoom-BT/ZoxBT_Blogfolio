...
Ce stage de recherche s'inscrit dans le cadre de mon cycle ingénieur (ING-5) à l'ENSPY, sous la supervision de **Norbert Tsopze** (Université de Yaoundé I), en collaboration avec le **Pr Bernard Fongang** (University of Texas, États-Unis).
