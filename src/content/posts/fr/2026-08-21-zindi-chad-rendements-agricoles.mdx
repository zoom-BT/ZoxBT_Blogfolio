...
flowchart TD
    ...
    classDef green fill:#007a3d,stroke:#00532a,color:#ffffff
    classDef red fill:#ce1126,stroke:#8f0c1a,color:#ffffff
    classDef yellow fill:#fcd116,stroke:#c9a600,color:#1a1a1a
    class A,B green
