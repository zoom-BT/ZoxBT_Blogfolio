...
excerpt: "Au hackathon Cameroonian Girls in STEAM, j'ai construit Gardienne pour donner aux filles victimes de cyberharcèlement au Cameroun de quoi comprendre, prouver et agir. Récit d'un projet, et d'une 2ᵉ place."
---
...
<Mermaid chart={`
flowchart LR
    A["Message reçu"] --> B["Normalisation<br/>NFD, minuscules, accents retirés"]
    B --> C["Lexique camfranglais/pidgin<br/>3 correspondances trouvées"]
    C --> D["Règle composite déclenchée<br/>Chantage / sextorsion"]
    B --> E["toxic-bert (navigateur)<br/>toxicité 0.94"]
    D --> F["Verdict final<br/>gravité 95, CRITIQUE"]
    E --> F
`} />
...
<Gallery images={[
  { src: "/images/blog/gardienne/gardienne-groupe-laureats.jpg", alt: "Photo de groupe avec les lauréats et les organisateurs" },
  { src: "/images/blog/gardienne/gardienne-promotrice.jpg", alt: "Avec la promotrice de l'événement" },
  { src: "/images/blog/gardienne/gardienne-remise-prix.jpg", alt: "Remise du prix au Technipole SupValor" },
  { src: "/images/blog/gardienne/gardienne-duo-prix.jpg", alt: "Photo avec le prix de la 2e place" },
  { src: "/images/blog/gardienne/gardienne-lots.jpg", alt: "Les lots remis : PC portable et chèque factice sur une table" },
  { src: "/images/blog/gardienne/gardienne-attente.jpg", alt: "Assis avec les autres finalistes en attendant les résultats" },
  { src: "/images/blog/gardienne/gardienne-salle-concentration.jpg", alt: "La salle du hackathon, les participantes concentrées sur leurs écrans" },
  { src: "/images/blog/gardienne/gardienne-jury-app.jpg", alt: "Un membre du jury ouvre l'application Gardienne sur son téléphone" }
]} />
...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5em', margin: '1em 0'}}>
  <div>
    <p style={{fontWeight: 700, marginBottom: '0.5em'}}>Démo</p>
  ...
  <div>
    <p style={{fontWeight: 700, marginBottom: '0.5em'}}>Récap de la cérémonie</p>
    <div style={{position: 'relative', paddingBottom: '56.25%', height: 0, borderRadius: '12px', overflow: 'hidden'}}>
      <iframe
        src="https://www.youtube.com/embed/fTcTraEXPCs"
        title="Gardienne - Récap de l'événement"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
        allowFullScreen
        style={{position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', border: 'none'}}
      />
