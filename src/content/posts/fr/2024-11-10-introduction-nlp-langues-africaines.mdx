...
Je suis **Balbino Tchoutzine**, étudiant en 4e année de Génie Informatique à l'ENSPY *(École Nationale Supérieure Polytechnique de Yaoundé)*, Deep Learning enthusiast. Si tu veux en savoir plus sur moi et mon parcours dans l'IA, [j'y consacre un article entier ici](/fr/blog/mon-parcours-ia). Mais aujourd'hui, je veux parler d'autre chose : ma langue maternelle, le **Medumba**.
...
Je suis actuellement le programme [Google DeepMind AI Research Foundations](https://www.skills.google/collections/deepmind), une excellente immersion dans les grands modèles de langage et leurs applications NLP, principalement centrées en Afrique. Je recommande si tu es étudiant en informatique.
...
*Ce projet est au début. Ce blog aussi. Mais les deux avancent, et je t'emmène avec moi.*
