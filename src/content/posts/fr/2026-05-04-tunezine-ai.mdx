...
Petit aveu avant de continuer : ce projet a deux noms.

**TuneZine AI** sur GitHub, le nom "sérieux", celui que tu mets dans un CV sans avoir honte.

**Tchoutzify** dans la vraie vie, parce que mon nom de famille c'est Tchoutzine, que ça sonne un peu comme Spotify, et que honnêtement c'est beaucoup plus marrant à dire à voix haute. Essaie. *Tchoutzify.* Tu vois.

Les deux désignent la même chose. Choisis celui que tu préfères.
...
<img src="/images/blog/wf1.jpg" alt="Le workflow spotify-watcher dans n8n" style={{maxWidth: '600px', width: '100%', margin: '1.5em auto', display: 'block', borderRadius: '8px'}} />
